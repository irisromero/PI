...
class UniverComentarTicketsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //Convocar el metodo para obtener los comentarios de los tickets
        obtenerComentarios()
    }
    
    //Metodo para obtener los comentarios de cada ticket y guardaos en arreglos
    ...
    @IBAction func enviarPregunta(_ sender: UIButton){
        ...
        do{try self.database.run(crearTabla)
        ...
        do{
            ...
            //Ejecutar un alert
            let alert = UIAlertController(title: "Exito", message: "Pregunta guardada correctamente", preferredStyle: .alert)
